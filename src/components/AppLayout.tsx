    ...
    <div className="flex min-h-screen">
      ...
      <aside className={cn(
        ...
        <div className="border-t border-sidebar-border p-4">
          ...
          <p className="mt-2 text-[10px] text-sidebar-foreground/40">v1.0 — Sistema BPA</p>
        </div>
      </aside>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center gap-4 border-b border-border bg-card px-4 lg:px-8">
          ...
          <span className="text-xs text-muted-foreground">BPA - Boletim Produção Ambulatorial</span>
        </header>
